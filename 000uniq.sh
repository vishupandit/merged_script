...
{   
   ...
   do
      ...
      cat ../tp1 | sed 's/-/ /g'|sed 's/mother/Mother/g'|sed 's/MOTHER/Mother/g'|sed 's/,o##/,Mother/g'|sed 's/,oo##/,Mother/g'|sed 's/mther/Mother/g'|sed 's/mOTHER/Mother/g'|sed 's/mothr/Mother/g'|sed 's/##/ /g' > $sf\_ 
   
      echo "\n\tFile $sf has processed and renamed to $sf\_"
      sleep 2
      mv $sf\_ Processed/$sf   
